...
import { useSuperAdminLoginMutation } from "@/api/superAdminsApiSlice";
import { setSuperAdminCredentials } from "@/api/authSlice";
...
const SuperAdminLogin = () => {
  ...
  const redirect =
    new URLSearchParams(search).get("redirect") || "/super-admin/dashboard";

  useEffect(() => {
    if (superAdmin) {
      navigate(redirect);
    }
  }, [redirect, superAdmin, navigate]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      dispatch(setSuperAdminCredentials(userData));
